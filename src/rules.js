...
export const CREATE_REQUIRED_TEXT_FIELDS = ['merchantOrderNo', 'currency'];
export const AMOUNT_PATTERN = new RegExp('^(0|[1-9][0-9]{0,15})(\\.[0-9]{1,2})?$');
export const WEBHOOK_URL_PREFIX = 'https://';

export const METHOD_EXTRA_FIELDS = {
  'APPLE_PAY': 'applePay',
  'BANK_CARD': 'bankCard',
